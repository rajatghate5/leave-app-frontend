...
const LeaveModal = ({
  ...
  today,
  loading,
  existingLeaves, // Array of existing leave requests
}) => {
        ...
        <Grid container spacing={2} mt={2} direction="column">
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              required
              inputProps={{ min: today }} // Set the minimum date to today
            />
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              InputLabelProps={{ shrink: true }}
              required
              inputProps={{ min: formData.startDate || today }} // End date should be after start date
            />
          </Grid>
